import { Frustum, Vector3, Matrix4, Quaternion, Camera, Scene } from 'three'
...
class SelectionBox {
  ...
  constructor(camera: Camera, scene: Scene, deep = Number.MAX_VALUE) {
    this.camera = camera
    this.scene = scene
  ...
  searchChildInFrustum(frustum: Frustum, object: any) {
